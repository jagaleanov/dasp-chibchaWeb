...
$router->add('/api/customers/details', 'CustomerController@customerDetails');
// $router->add('GET', '/api/customers/new', 'CustomerController@newCustomer', true);
...
$router->add('/api/credit-cards/validate', 'CreditCardController@validateCreditCard');
...
// // Hosts
// $router->add('GET', '/api/hosts/customer/{id}', 'HostController@getCustomerHosts', true);
...
// $router->add('PATCH', '/api/payments/{id}/set-status', 'PaymentController@updatePaymentStatus', true);
...
// Orders
$router->add('/api/orders/amount', 'OrderController@getAmount');
// $router->add('/api/orders', 'OrderController@createOrder');

$router->add('/api/orders/new', 'OrderController@newOrder');
